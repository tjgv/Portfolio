...
export default function InlinePillReveal({
  ...
  return (
    <>
      <div
        ref={pillRootRef}
        className={`np1-inline-pill np1-popup-aap np1-inline-pill--${align}${controlsReady ? ' np1-inline-pill--ready' : ''}${overlayActive ? ' np1-inline-pill--overlay-open' : ''}`}
        style={controlStyle}
      >
        <div className="np1-inline-pill__stage">
          <div className="np1-inline-pill__pill-measure" ref={pillMeasureRef} aria-hidden>
            <span className="np1-inline-pill__action-sizer" aria-hidden />
            <span className="np1-inline-pill__cta-text">{ctaLabel}</span>
          </div>

          <div className="np1-inline-pill__cluster">
            <button
              type="button"
              className="np1-inline-pill__shell"
              onClick={handleOpen}
            ...
            >
              <span className="np1-inline-pill__action-grow" aria-hidden>
                <span className="np1-inline-pill__action">
