...
export default function EmbedControlledVideo({ src, ariaLabel, hideReset, objectPosition }: EmbedControlledVideoProps) {
  ...
  return (
    <div
      ref={wrapRef}
      className="np1-embed-video-controlled"
    ...
    >
      ...
      {!hideReset && (
        <button
          type="button"
          className="np1-embed-video-reset"
          onClick={handleReset}
          aria-label="Restart video from beginning"
        >
          <svg className="np1-embed-video-progress" viewBox="0 0 36 36" aria-hidden>
            <circle
              className="np1-embed-video-progress__track"
              cx="18"
              cy="18"
              r={PROGRESS_RADIUS}
            />
            <circle
              className="np1-embed-video-progress__fill"
              cx="18"
              cy="18"
              r={PROGRESS_RADIUS}
          ...
          <span className="np1-embed-video-reset__icon">
            <ResetIcon />
          </span>
        </button>
      )}
      ...
      {!isPlaying && (
        <span className="np1-embed-video-giant-play" aria-hidden>
          <GiantPlayIcon />
        </span>
      )}
    </div>
