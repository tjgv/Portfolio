...
export default function EndHeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="np1-section np1-end-hero"
      data-dev-section="end-hero"
      aria-label="Closing"
    >
      <RevealGradient className="np1-end-hero__gradient" />

      <div className="np1-end-hero__stage">
        <div className="np1-section__inner np1-end-hero__inner">
          <ImgWithLoader
            className="np1-end-hero__image"
            src={END_HERO_IMAGE}
            alt=""
            aria-hidden="true"
          />
