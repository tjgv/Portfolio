  ...
  return (
    ...
    >
      <header className="np1-carousel-section__header">
        <div className="np1-section__inner np1-carousel-section__copy">
          {label ? <p className="np1-carousel-section__label">{label}</p> : null}
          <h2 className="np1-carousel-section__headline">{headline}</h2>
          {body ? <p className="np1-carousel-section__lede">{body}</p> : null}
        </div>
      </header>
      ...
      <div className="np1-carousel-section__body">
        <div
          ...
          tabIndex={0}
        >
          <ul ref={trackRef} className="np1-carousel-section__track">
            {slides.map((slide, index) => {
              ...
              <li
                ...
                className={`np1-carousel-section__slide${isNarrow ? ' np1-carousel-section__slide--narrow' : ''}${index === activeIndex ? ' np1-carousel-section__slide--active' : ''}`}
                style={narrowStyle}
                aria-hidden={index !== activeIndex}
              >
                <div className="np1-carousel-section__media-slot">
                  <figure
                  ...
                  >
                    ...
                    {slide.kind === 'video' ? (
                      <VideoWithLoader
                        ...
                        className="np1-carousel-section__video"
                        src={slide.src}
                ...
                <p className="np1-carousel-section__caption">{slide.caption}</p>
              </li>
              )
            })}
          </ul>
