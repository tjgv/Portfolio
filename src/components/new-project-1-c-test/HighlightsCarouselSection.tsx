                    ...
                    {slide.kind === 'video' ? (
                      <div className="np1c-carousel-section__video-wrap">
                        <VideoWithLoader
                          ...
                          style={
                            slide.objectPosition || slide.offsetY
                              ? {
                                  ...
                                  ...(slide.offsetY
                                    ? {
                                        /* Taller than the frame, top-aligned — shifts content
                                           down by offsetY while still covering (no gap). */
                                        height: `calc(100% + ${slide.offsetY}px)`,
                                        width: '100%',
                                        maxHeight: 'none',
                                        objectFit: 'cover',
                                      }
