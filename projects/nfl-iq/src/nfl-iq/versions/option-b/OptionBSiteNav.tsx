...
import './option-b-site-nav.css'

type OptionBSiteNavProps = {
  onAskIq?: () => void
}

export function OptionBSiteNav({ onAskIq }: OptionBSiteNavProps) {
    ...
    <nav aria-label="Site" className="site-nav">
      <div className="site-nav__container">
        <div className="site-nav__left">
          <a className="site-nav__logo-link" href={appRoute('/')} aria-label="Option B prototype">
            <span className="option-b-site-nav__mark" aria-hidden>(B)</span>
          </a>
