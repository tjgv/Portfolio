...
import { DraftCentralGotCell } from './DraftCentralGotCell'
import { DraftCentralRivalsCell } from './DraftCentralRivalsCell'
...
type OptionADraftCombineScorecardRowsProps = {
  rows: DraftBoardProspect[]
  teamNeedsLayout: DraftCentralTeamNeedsLayout | null
}

export function OptionADraftCombineScorecardRows({
  rows,
  teamNeedsLayout,
}: OptionADraftCombineScorecardRowsProps) {
  return (
    <>
      {rows.map((p) => {
