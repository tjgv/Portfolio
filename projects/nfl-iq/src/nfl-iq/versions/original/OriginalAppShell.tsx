...
import { OriginalSiteNav } from './OriginalSiteNav'
import '../../nfl-iq.css'

export function OriginalAppShell() {
  ...
  return (
    <IqTeamProvider>
      <div className="nfl-iq" data-mock-version="original">
        <a className="iq-skip" href="#main-content">
          Skip to main content
        </a>
        <OriginalSiteNav onAskIq={() => setChatOpen(true)} />
        <QuicksuiteToolbar />
